package com.i2n.spyfall.views.lobby;

import java.util.Optional;

import com.i2n.spyfall.data.entity.Person;
import com.i2n.spyfall.data.service.PersonService;
...
@PageTitle("Lobby")
@CssImport("./styles/views/lobby/lobby-view.css")
...
public class LobbyView extends Div {
    ...
    public LobbyView(@Autowired PersonService personService) {
        setId("lobby-view");
        // Create UI
